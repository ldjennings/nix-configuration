...
_: {
  flake.modules.homeManager.hyprland = _: {
    # Hyprland 0.55 windowrule v3 syntax: every field is "<name> <value>",
    # matchers take a match: prefix, boolean effects need an explicit value.
    wayland.windowManager.hyprland.settings.windowrule = [
      ...
      "opacity 1.0 1.0, match:tag settings*"
