{
  ...
  gitEmail = "ldjennings@github.com";
  ...
  # extraMonitorSettings ="monitor = eDP-1,2256x1504@59.99900, auto,1.5";
  # extraMonitorSettings = [
  #   "monitor = eDP-1,2256x1504@59.99900, auto,1.5"
  #   "monitor = DP-7,1920x1080@60.00000, auto, .5"
  #   ];
    extraMonitorSettings =''
